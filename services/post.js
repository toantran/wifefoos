(function() {
  ...
  exports.makePostGen = function(user) {
    return function(post, callback) {
      var data, genDesc, returnback, setDesc, setPictureUrl, _ref, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (callback == null) callback = function() {};
      ...
      switch (post.type) {
        ...
        case 'challengecancelled':
          return teamsvc.getById(post != null ? (_ref6 = post.data) != null ? _ref6.teamid : void 0 : void 0, function(err, team) {
            if (err) return returnback(err);
            setPictureUrl(team != null ? team.pictureurl : void 0);
            data.teamid = team != null ? team._id : void 0;
            data.teamname = team != null ? team.teamname : void 0;
        ...
        case 'challengecancelling':
          setPictureUrl(user != null ? user.pictureurl : void 0);
          data.matchtype = post != null ? (_ref7 = post.data) != null ? _ref7.matchtype : void 0 : void 0;
          data.matchmsg = post != null ? (_ref8 = post.data) != null ? _ref8.msg : void 0 : void 0;
          return teamsvc.getById(post != null ? (_ref9 = post.data) != null ? _ref9.teamid : void 0 : void 0, function(err, team) {
            if (err) return returnback(err);
            data.teamid = team != null ? team._id : void 0;
            data.teamname = team != null ? team.teamname : void 0;
            try {
        ...
        case 'teamchallenged':
          data.matchtype = post != null ? (_ref10 = post.data) != null ? _ref10.matchtype : void 0 : void 0;
          data.matchmsg = post != null ? (_ref11 = post.data) != null ? _ref11.msg : void 0 : void 0;
          return teamsvc.getById(post != null ? (_ref12 = post.data) != null ? _ref12.teamid : void 0 : void 0, function(err, team) {
            if (err) return returnback(err);
            setPictureUrl(team != null ? team.pictureurl : void 0);
            data.teamid = team != null ? team._id : void 0;
            data.teamname = team != null ? team.teamname : void 0;
        ...
        case 'newmatch':
          ...
          return matchsvc.getById(post.data.matchid, function(err, am) {
            ...
            if (err) return returnback(err);
            data.teamid = am != null ? (_ref13 = am.teams[0]) != null ? _ref13._id : void 0 : void 0;
            data.teamname = am != null ? (_ref14 = am.teams[0]) != null ? _ref14.teamname : void 0 : void 0;
            data.otherteamid = am != null ? (_ref15 = am.teams[1]) != null ? _ref15._id : void 0 : void 0;
            data.otherteamname = am != null ? (_ref16 = am.teams[1]) != null ? _ref16.teamname : void 0 : void 0;
        ...
        case 'post':
          data.postbody = post != null ? (_ref13 = post.data) != null ? _ref13.msg : void 0 : void 0;
          return usersvc.getById(post != null ? (_ref14 = post.data) != null ? _ref14.posterid : void 0 : void 0, function(err, poster) {
            if (err) return returnback(err);
        ...
        case 'matchresult':
          setPictureUrl(user != null ? user.pictureurl : void 0);
          data.result = post != null ? (_ref15 = post.data) != null ? _ref15.result : void 0 : void 0;
          return teamsvc.getById(post != null ? (_ref16 = post.data) != null ? _ref16.opponentid : void 0 : void 0, function(err, team) {
            if (err) return returnback(err);
            setPictureUrl(team != null ? team.pictureurl : void 0);
            data.teamid = team != null ? team._id : void 0;
            data.teamname = team != null ? team.teamname : void 0;
